...
function App() {
  ...
  const filteredDictionary = useMemo(() => {
    const query =
      dictionarySearch.trim().toLowerCase();
        ...
        {page === "learn" && (
          <section className="page">
            ...
            <div className="offline-info">
              ...
              <div>
                <strong>
                  More lessons coming later
                </strong>

                <span>
                  Number counting has been
                  removed for now and can be
